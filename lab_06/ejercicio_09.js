...
operacion("Resta", 27, 9);
operacion("Resta", 48, 6);
operacion("Multiplicacion", 20, 5);
operacion("Multiplicacion", 10, 2);
operacion("Multiplicacion", 27, 9);
operacion("Multiplicacion", 48, 6);
operacion("Division", 20, 5);
operacion("Division", 10, 2);
operacion("Division", 27, 9);
operacion("Division", 48, 6);
